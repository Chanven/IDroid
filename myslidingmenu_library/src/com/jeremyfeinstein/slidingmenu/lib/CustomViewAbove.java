...
public class CustomViewAbove extends ViewGroup {
	...
	private boolean mLeftEnabled = true;
	
	private boolean mRightEnabled = true;
	...
	public void scrollTo(int x, int y) {
		Log.d(TAG, "scrollTo(int x, int y) with x =" + x + " y=" + y + " and getScrollX()=" + getScrollX());
		super.scrollTo(x, y);
		mScrollX = x;
	...
	public float getOpenedWidth(){
		return mScrollX-mContent.getLeft();
	}
	...
	public void drawFade(Canvas canvas, float openPercent) {
		...
		if (mViewBehind.getMode() == SlidingMenu.LEFT) {
			left = getLeft() - getBehindWidth();
			right = getLeft() + getWidth();
		} else if (mViewBehind.getMode() == SlidingMenu.RIGHT) {
			left = getRight() - getWidth();
			right = getRight() + getBehindWidth();			
